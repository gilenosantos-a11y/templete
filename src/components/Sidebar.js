          ...
          <ul className="menu">
            ...
            <li className="sidebar-item has-sub">
              <a
                ...
                onClick={() => handleSubmenuClick('components')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'extra-components' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('extra-components')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'layouts' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('layouts')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'form-elements' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('form-elements')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'form-editor' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('form-editor')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'widgets' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('widgets')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'icons' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('icons')}
              >
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'maps' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('maps')}
              >
                <i className="bi bi-map-fill"></i>
                <span>Maps</span>
              </a>
              <ul
                className={`submenu ${openSubmenu === 'maps' ? 'active' : ''}`}
              >
                <li className="submenu-item">
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'auth' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('auth')}
              >
                <i className="bi bi-person-badge-fill"></i>
                <span>Authentication</span>
              </a>
              <ul
                className={`submenu ${openSubmenu === 'auth' ? 'active' : ''}`}
              >
                <li className="submenu-item">
            ...
            <li
              className={`sidebar-item has-sub ${
                openSubmenu === 'errors' ? 'active' : ''
              }`}
            >
              <a
                href="#"
                className="sidebar-link"
                onClick={() => handleSubmenuClick('errors')}
              >
                <i className="bi bi-x-octagon-fill"></i>
                <span>Errors</span>
              </a>
              <ul
                className={`submenu ${openSubmenu === 'errors' ? 'active' : ''}`}
              >
                <li className="submenu-item">
