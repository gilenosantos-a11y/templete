<>
  {"{"}% set title = 'Checkbox' %{"}"}
  {"{"}% set filename = 'form-element-checkbox.html' %{"}"}
            ...
            <div className="card-content">
              <div className="card-body">
                <p>
                  ...
                  <code>.form-check-sm</code> class for small Checkboxes. Add it
                  alongwith <code>.form-check</code> class.
                </p>
                <ul className="list-unstyled mb-0">
